...
<div class="container">
	<div class="no-gutter row">
              ...
              <div class="panel" id="midCol">
                <div class="panel-heading" style="background-color:#555;color:#eee;" align="center"><h2><?php echo Auth::user()->tipe ?></h2></div> 
                <div class="panel-body">
                  
                  <img class="img-responsive" src="<?php echo asset('images/'.Auth::user()->photo) ?>" width="800px" height="800px" >
      		...
      		<div class="col-md-7" id="content" width="60%">
          <div class="panel">
    			<div class="panel-heading" style="background-color:#111;color:#fff;">Top Stories</div>   
                  ...
                  <div class="well">
                   ...
                   ?>
                    ...
                    <div class="media-body">
                      <h5 class="media-heading"><a href="/tagged/modal" target="ext" class="pull-right"><i class="glyphicon glyphicon-share"></i></a> <a href="{{url('profile/view/' .$pesan->user_id )}}"><strong>{{$pesan->name}}</strong></a></h5>
