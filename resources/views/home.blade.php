...
<header class="masthead">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h1><a href="#" title="Scroll down for your viewing pleasure">The Next Model</a>
          <p class="lead">conecting model to agency</p></h1>
      </div>
      <div class="col-md-6">
	...
	<div class="no-gutter row">
              ...
              <div class="panel" id="midCol">
                ...
                <div class="panel-body">
                  ...
                  <img class="img-responsive" src="<?php echo asset('images/'.Auth::user()->photo) ?>">
